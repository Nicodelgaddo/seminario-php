...
function validarImagen($imagenBase64)
{
    if ($imagenBase64 !== null) {
        // Decodificar la imagen en base64
        $decodedImage = base64_decode($imagenBase64);
        ...
        if ($imgInfo !== false) {
            ...
            if (in_array($imgInfo[2], $allowedTypes)) {
                ...
                if ($imageSize <= $maxFileSize) {
                    // La imagen es válida
                    return $imagenBase64; // Devuelve la imagen decodificada
                }
            }
        }
    }
...
function validarCampos($data)
{
    ...
    if ($nombre !== null || $precio !== null || $tipo !== null || $imagen !== null || $tipo_imagen !== null) {
        ...
        if (!empty($camposInvalidos)) {
            return "El campo '" . implode("' y '", $camposInvalidos) . "' es inválido";
        }

        return true;
    } else {
        return "Ningún campo fue enviado";
    }
}
